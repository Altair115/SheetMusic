...
namespace SheetMusic.iAz_Magic
{
    ...
    {
        static string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\Sheetz.mdf;Integrated Security=True";
        static string provider = "System.Data.SqlClient";
        static Database db = Database.OpenConnectionString(connectionString, provider);


        public static void yoinkintoDatabase(string PieceName, string PieceSubName, string PieceGenre, string PieceArtist,
...
#region isEmptychecks
            ...
            db.Execute("INSERT INTO Pieces(PieceName, PieceSubName, Genre, Year, Difficulty, Description, User_Id, Artist) VALUES(@0, @1, @2, @3, @4, @5, @6, @7)",
